...
```{bash}
# For all unrelated samples
python pcangsd-0.973/pcangsd.py -beagle WR.49I.above13Mb_NoSexChr_NonMaskedRegions_GL2_unrelated.tv.beagle.gz -o WR.49I.above13Mb_NoSexChr_NonMaskedRegions_GL2_unrelated.tv -threads 20 -maf_iter 200


# Per subspecies
## NWR
python pcangsd-0.973/pcangsd.py -beagle NWR.24I.above13Mb_NoSexChr_NonMaskedRegions_GL2_unrelated.tv.beagle.gz -o NWR.24I.above13Mb_NoSexChr_NonMaskedRegions_GL2_unrelated.tv -threads 20 -maf_iter 200

## SWR
python pcangsd-0.973/pcangsd.py -beagle SWR.25I.above13Mb_NoSexChr_NonMaskedRegions_GL2_unrelated.tv.beagle.gz -o SWR.25I.above13Mb_NoSexChr_NonMaskedRegions_GL2_unrelated.tv -threads 20 -maf_iter 200
...
# Parsing output and visualization
...
```{r}
evec$window_country=factor(evec$window_country,levels=c("NWRpre DRC", "NWRpre South Sudan", "NWRpre Uganda", "NWRpost Sudan", "NWRpost South Sudan", "NWRpost Uganda", "SWRpre South Africa", "SWRpre Namibia", "SWRpost unknown", "SWRpost South Africa", "SWRpost captive"))
```
...
```{r}
evecNWR$window_country=factor(evecNWR$window_country, levels=c("NWRpre DRC", "NWRpre South Sudan", "NWRpre Uganda", "NWRpost Sudan", "NWRpost South Sudan", "NWRpost Uganda"))
```
