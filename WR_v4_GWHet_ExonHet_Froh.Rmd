...
fRoh = ggplot(data=subset(data, lab_ID!='mwr_TG0450' & lab_ID!='mwr_TG0451' & lab_ID!='mwr_TG0456' & lab_ID!='mwr_TGF01' & lab_ID!='mwr_TGF02' & lab_ID!='mwr_TGF04' & lab_ID!='mwr_TG0452' & lab_ID!='mwr_TG0461'),
       aes(time_window, Froh63_min10kb_Tv)) +
...
Comparison of RoH analyses: with 10 scaffolds, 63 scaffolds and only Tv
...
ggplot(data=subset(data, lab_ID!='mwr_TG0450' & lab_ID!='mwr_TG0451' & lab_ID!='mwr_TG0456' & lab_ID!='mwr_TGF01' & lab_ID!='mwr_TGF02' & lab_ID!='mwr_TGF04' & lab_ID!='mwr_TG0452' & lab_ID!='mwr_TG0461'),
  ...
  geom_point(aes(sample_name, Froh), colour="black") +
  geom_point(aes(sample_name, Froh63_min10kb), colour="blue") +
  geom_point(aes(sample_name, Froh63_min10kb_Tv), colour="green") +
...
ggplot(data=subset(data, lab_ID!='mwr_TG0450' & lab_ID!='mwr_TG0451' & lab_ID!='mwr_TG0456' & lab_ID!='mwr_TGF01' & lab_ID!='mwr_TGF02' & lab_ID!='mwr_TGF04' & lab_ID!='mwr_TG0452' & lab_ID!='mwr_TG0461'),
  ...
  geom_point(aes(sample_name, ave_RoH_len), colour="black") +
  geom_point(aes(sample_name, Avg_RoH_len_63min10kb), colour="blue") +
  geom_point(aes(sample_name, Avg_RoH_len_63min10kb_Tv), colour="green") +
...
ggplot(data=subset(data, lab_ID!='mwr_TG0450' & lab_ID!='mwr_TG0451' & lab_ID!='mwr_TG0456' & lab_ID!='mwr_TGF01' & lab_ID!='mwr_TGF02' & lab_ID!='mwr_TGF04' & lab_ID!='mwr_TG0452' & lab_ID!='mwr_TG0461'),
  ...
  geom_point(aes(sample_name, max_RoH_len), colour="black") +
  geom_point(aes(sample_name, Max_RoH_len_63min10kb), colour="blue") +
  geom_point(aes(sample_name, Max_RoH_len_63min10kb_Tv), colour="green") +
