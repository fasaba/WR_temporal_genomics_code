...
aveRoh = ggplot(data=subset(data, lab_ID!='mwr_TG0450' & lab_ID!='mwr_TG0451' & lab_ID!='mwr_TG0456' & lab_ID!='mwr_TGF01' & lab_ID!='mwr_TGF02' & lab_ID!='mwr_TGF04' & lab_ID!='mwr_TG0452' & lab_ID!='mwr_TG0461'),
       aes(time_window, avg_roh_len_100kbmin)) +
  
  scale_y_continuous(limits=c(100000, 1000000), labels = function(x) format(x/1000000, digits=3, nsmall=2), breaks=seq(100000, 1000000, 200000)) +
...
aveRoh = aveRoh + stat_compare_means(paired=F, method = "wilcox.test", comparisons = list(c("NWRpre", "NWRpost"), c("SWRpre", "SWRpost")), method.args = list(alternative = "less"), label.y=c(700000, 960000), size=3, colour="gray20") #+
...
maxRoh = ggplot(data=subset(data, lab_ID!='mwr_TG0450' & lab_ID!='mwr_TG0451' & lab_ID!='mwr_TG0456' & lab_ID!='mwr_TGF01' & lab_ID!='mwr_TGF02' & lab_ID!='mwr_TGF04' & lab_ID!='mwr_TG0452' & lab_ID!='mwr_TG0461'),
       aes(time_window, max_roh_len_100kbmin)) +
  
  # customize the y axis scale
  scale_y_continuous(limits=c(0, 15000000), labels = function(x) format(x/1000000, digits=3, nsmall=2), breaks=seq(1000000, 14000000, 2000000)) +
...
maxRoh = maxRoh +  
  ...
  stat_compare_means(paired=F, method = "wilcox.test", comparisons = list(c("NWRpre", "NWRpost"), c("SWRpre", "SWRpost")), method.args = list(alternative = "less"), label.y=c(13500000, 14500000), size=3, colour="gray20") #+
...
```{r}
pdf("WR_v5_Fig4_GE100kbmin.pdf", useDingbats = F)
erosion
dev.off()
```
...
# perform wilcox tests to compare groups
aveRohss = aveRohss + stat_compare_means(paired=F, method = "wilcox.test", comparisons = list(c("NWRpre", "NWRpost"), c("SWRpre", "SWRpost")), method.args = list(alternative = "less"), label.y=c(700000, 960000), size=3, colour="gray20") #+
...
```{r}
pdf("WR_v5_FigS8_GESSmin100kb.pdf",  useDingbats = F)
erosionss
dev.off()
```
