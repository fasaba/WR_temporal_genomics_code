...
Y = Y + theme(axis.text=element_text(size=6), axis.title=element_text(size=8))
...
Z = Z + theme(axis.text.x=element_text(angle=90, size=5), axis.text.y=element_text(size=8), axis.title=element_text(size=8))
...
```{r}
# pdf('WR_v3_FigS2_scfs_v1.pdf', height=5, width=5, useDingbats = F)
...
f = ggplot(NWR1, aes(Sample, AveScaffoldDepth)) + 
  theme_bw() + theme(legend.position = "none", axis.text.x=element_text(angle=40, hjust=1, size=6, colour='black'), axis.text.y=element_text(size=6, colour="black"), axis.title.y=element_text(size=6), 
                     panel.grid.major=(element_line(size=.12, colour='gray80'))) +
  geom_violin(aes(Sample, AveScaffoldDepth), fill="gray50", colour="gold3", alpha=.4, lwd=.2) +
  scale_x_discrete(labels=as.character(NWR1_newID)) +
  scale_y_continuous(limits=c(0, 25)) +
  stat_summary(fun="median", geom="crossbar", width=.09, lwd=.2, colour="gray5") +
...
g = ggplot(NWR2, aes(Sample, AveScaffoldDepth)) + 
  theme_bw() + theme(legend.position = "none", axis.text.x=element_text(angle=40, hjust=1, size=6, colour='black'), axis.text.y=element_text(size=6, colour="black"), axis.title.y=element_text(size=6), 
                     panel.grid.major=(element_line(size=.12, colour='gray80'))) +
  geom_violin(aes(Sample, AveScaffoldDepth), fill="gray50", colour="darkorange", alpha=.4, lwd=.2) +
...
h = ggplot(SWR1, aes(Sample, AveScaffoldDepth)) + 
  theme_bw() + theme(legend.position = "none", axis.text.x=element_text(angle=40, hjust=1, size=6, colour='black'), axis.text.y=element_text(size=6, colour="black"), axis.title.y=element_text(size=6), 
                     panel.grid.major=(element_line(size=.12, colour='gray80'))) +
  geom_violin(aes(Sample, AveScaffoldDepth), fill="gray50", colour="royalblue4", alpha=.4, lwd=.2) +
...
i = ggplot(SWR2, aes(Sample, AveScaffoldDepth)) + 
  theme_bw() + theme(legend.position = "none", axis.text.x=element_text(angle=40, hjust=1, size=6, colour='black'), axis.text.y=element_text(size=6, colour="black"), axis.title.y=element_text(size=6), 
                     panel.grid.major=(element_line(size=.12, colour='gray80'))) +
  geom_violin(aes(Sample, AveScaffoldDepth), fill="gray50", colour="steelblue3", alpha=.4, lwd=.2) +
...
```{r}
# pdf('WR_v3_FigS2_depths_v2.pdf', height=4, width=5, useDingbats = F)
